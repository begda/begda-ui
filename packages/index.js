...
import { Platforms, PlatformsSync } from "./plateform/src/platforms";
...
const install = function (Vue, opts = {}) {
  ...
  Vue.prototype.$BaPlatformsSync = PlatformsSync; // 给vue注册运行平台判断代码
  Vue.prototype.$BaEnv = Env; // 给vue注册开发环境判断代码
};
